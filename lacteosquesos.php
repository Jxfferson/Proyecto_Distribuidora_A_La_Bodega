...
<section class="contenedor">
        ...
        <div class="contenedor-items">
            <div class="item">
                <span class="titulo-item">Queso de cabra</span> <br>
                <img src="lacteos/cabra.png" alt="" class="img-item">
                <span class="precio-item">$ 14.450</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item">
                <span class="titulo-item">Crema de leche</span> <br>
                <img src="lacteos/cremaleche.png" alt="" class="img-item">
                <span class="precio-item">$ 10.960</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item">
                <span class="titulo-item">Queso fresco</span> <br>
                <img src="lacteos/fresco.png" alt="" class="img-item">
                <span class="precio-item">$ 9.000</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item">
                <span class="titulo-item">Leche </span> <br>
                <img src="lacteos/leche.png" alt="" class="img-item">
                <span class="precio-item">$ 5.200</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <center>
            <div class="item">
                <span class="titulo-item">Queso madurado</span> <br>
                <img src="lacteos/madurado.png" alt="" class="img-item">
                <span class="precio-item">$ 17.800</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            </center>
            <div class="item">
                <span class="titulo-item">Mantequilla</span> <br>
                <img src="lacteos/mantequilla.png" alt="" class="img-item">
                <span class="precio-item">$ 6.800</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item">
                <span class="titulo-item">Queso parmesano</span> <br>
                <img src="lacteos/parmesano.png" alt="" class="img-item">
                <span class="precio-item">$ 9.800</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item">
                <span class="titulo-item">Yogourt</span> <br>
                <img src="lacteos/yogur.png" alt="" class="img-item">
                <span class="precio-item">$ 6.800</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
        </div>
