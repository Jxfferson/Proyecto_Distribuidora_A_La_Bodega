...
<body>
    ...
    <hr>
    <center>
        <h2 class="circulos">Embutidos</h2>
    </center>
    <style>
        p {
            color: white;
    ...
    <section class="contenedor">
        ...
        <div class="contenedor-items">
            <div class="item">
                <span class="titulo-item">Chorizo</span> <br>
                <img src="../embutidos/chorizo.png" alt="" class="img-item">
                <span class="precio-item">$ 11.000</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item">
                <span class="titulo-item">Longaniza</span> <br>
                <img src="../embutidos/longaniza.png" alt="" class="img-item">
                <span class="precio-item">$ 13.000</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item">
                <span class="titulo-item">Morcilla</span> <br>
                <img src="../embutidos/morcilla.png" alt="" class="img-item">
                <span class="precio-item">$ 7.500</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item">
                <span class="titulo-item">Salchicha</span> <br>
                <img src="../embutidos/salchicha.png" alt="" class="img-item">
                <span class="precio-item">$ 6.500</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item" >
                <span class="titulo-item">Salchichon</span> <br>
                <img src="../embutidos/salchichon.png" alt="" class="img-item">
                <span class="precio-item">$ 6.800</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item" >
                <span class="titulo-item">Semi Ahumado</span> <br>
                <img src="../embutidos/semiahumado.png" alt="" class="img-item">
                <span class="precio-item">$ 24.150</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
        </div>
        <!-- Carrito de Compras -->
...
<footer class="piedepagina">
    <div class="grupo1">
        <div class="caja">
            <figure>
                <a href="#">
                    <img src="empresa/WhatsApp Image 2023-09-21 at 5.39.11 PM.jpeg" class="logo">
                </a>
             </figure>
             </div>
             <div class="caja">
