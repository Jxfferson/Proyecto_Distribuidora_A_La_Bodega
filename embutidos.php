    ...
    <section class="contenedor">
        <div class="contenedor-items">
            <div class="item" data-id="1">
                ...
                <img src="embutidos/chorizo.png" alt="Chorizo" class="img-item">
                <span class="precio-item">$ 11.000</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item" data-id="2">
                <span class="titulo-item">Longaniza</span>
                <img src="embutidos/longaniza.png" alt="Longaniza" class="img-item">
                <span class="precio-item">$ 13.000</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item" data-id="3">
                <span class="titulo-item">Morcilla</span>
                <img src="embutidos/morcilla.png" alt="Morcilla" class="img-item">
                <span class="precio-item">$ 7.500</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item" data-id="4">
                <span class="titulo-item">Salchicha</span>
                <img src="embutidos/salchicha.png" alt="Salchicha" class="img-item">
                <span class="precio-item">$ 6.500</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item" data-id="5">
                <span class="titulo-item">Salchichón</span>
                <img src="embutidos/salchichon.png" alt="Salchichón" class="img-item">
                <span class="precio-item">$ 6.800</span>
                <button class="boton-item">Agregar al Carrito</button>
            </div>
            <div class="item" data-id="6">
                <span class="titulo-item">Semi Ahumado</span>
                <img src="embutidos/semiahumado.png" alt="Semi Ahumado" class="img-item">
...
//Agregamos la funciòn del carrito,cambio de tema y alertas con SWEETALERT
<script>
